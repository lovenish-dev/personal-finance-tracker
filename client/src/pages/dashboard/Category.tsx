                                            ...
                                            >
                                                ...
                                                <div className="flex gap-2">
                                                    <button
                                                        ...
                                                        className="flex-1 flex justify-center cursor-pointer disabled:cursor-not-allowed disabled:opacity-50 rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white transition hover:bg-blue-700"
                                                    >
                                                        {editingCategory ? <ButtonLoader /> : "Save"}
                                                    </button>
